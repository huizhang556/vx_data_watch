...
export default function OnlineUpdateSection() {
  ...
  const loadVersions = async (selectedRegistry = registry) => {
    ...
    setVersionLoading(true); setVersionError(''); setVersionInfo(null); setTargetVersion(undefined)
    try {
