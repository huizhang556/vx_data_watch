...
import { Button, Card, Descriptions, Form, Input, Space, Upload, Typography, message } from 'antd'
...
export default function ProfilePage() {
  ...
  const avatarPicker = <Upload accept="image/*" showUploadList={false} beforeUpload={readAvatar}><button type="button" className="profile-avatar-button" title="点击上传头像" aria-label="点击上传头像"><UserAvatar size={72} username={draftUsername || user.username} avatar={avatar} role={user.role} level={user.level} /></button></Upload>
